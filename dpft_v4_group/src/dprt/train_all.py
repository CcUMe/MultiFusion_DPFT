...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', type=str, default='/mnt/disk3/zhangzhibin/dataset/kradar',
                        help="Path to the processed dataset folder.")
    parser.add_argument('--cfg', type=str, default='/mnt/disk3/zhangzhibin/goals-2/dpft_v4/config/kradar_all.json',
                        help="Path to the configuration file.")
    parser.add_argument('--dst', type=str, default='/mnt/disk3/zhangzhibin/test/group2222',
                        help="Path to save the training log.")
    parser.add_argument('--checkpoint', type=str,default='/mnt/disk3/zhangzhibin/test/group2222/20260425-113125-148/checkpoints/20260425-113125-148_checkpoint_0009.pt',
