...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', type=str, default='/mnt/disk3/xiaxue/dataset/k_radar_v1.1',
                        help="Path to the processed dataset folder.")
    parser.add_argument('--cfg', type=str, default='/mnt/disk3/zhangzhibin/dpft_v4/config/kradar.json',
                        help="Path to the configuration file.")
    parser.add_argument('--dst', type=str, default='/mnt/disk3/zhangzhibin/test/all',
                        help="Path to save the training log.")
    parser.add_argument('--checkpoint', type=str,default='/mnt/disk3/zhangzhibin/test/all/20260401-145200-958/checkpoints/20260401-145200-958_checkpoint_0025.pt',
